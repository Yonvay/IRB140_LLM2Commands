...
elements = ['cubo rojo', 'cubo amarillo']
objectsPosition = [[300, 300, 200], [700, -200, 200]] #Red, yellow
...
def fixCommands(arrayCommands):
    ...
    if targets[0] != lastCommandTarget and lastCommandTarget != 'none': #does he already have something?
